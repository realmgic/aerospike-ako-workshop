...
In-memory variant: use `-f helm/dim-cluster-values.yaml -f helm/dim-pod-warm-restart-op-values.yaml` (with `--dim` / `CLUSTER_STORAGE=dim`).
...
In-memory variant: use `-f helm/dim-cluster-values.yaml -f helm/dim-pod-restart-op-values.yaml` (with `--dim` / `CLUSTER_STORAGE=dim`).
...
- **WarmRestart operation:**
  ...
  - Path B: [helm/disk-cluster-values.yaml](../../helm/disk-cluster-values.yaml) + [helm/disk-pod-warm-restart-op-values.yaml](../../helm/disk-pod-warm-restart-op-values.yaml) (default) · [helm/dim-cluster-values.yaml](../../helm/dim-cluster-values.yaml) + [helm/dim-pod-warm-restart-op-values.yaml](../../helm/dim-pod-warm-restart-op-values.yaml) (`--dim`)
- **PodRestart operation:**
  ...
  - Path B: [helm/disk-cluster-values.yaml](../../helm/disk-cluster-values.yaml) + [helm/disk-pod-restart-op-values.yaml](../../helm/disk-pod-restart-op-values.yaml) (default) · [helm/dim-cluster-values.yaml](../../helm/dim-cluster-values.yaml) + [helm/dim-pod-restart-op-values.yaml](../../helm/dim-pod-restart-op-values.yaml) (`--dim`)
